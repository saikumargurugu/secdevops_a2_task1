...
3. Start Nodemon server at http://localhost:3001 (the `start:dev` script must be used since `nodemon.json` is used to store environment variables, and the other scripts do not use Nodemon)
